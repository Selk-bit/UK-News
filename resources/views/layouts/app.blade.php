...
<body class="theme-1">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 align-self-center">
					<div class="banner1">
						<a href="#">
							<img width="700" height="100" src="{{ asset('/images/banner_1.jpg')  }}" alt="">
						</a>
					</div>
				</div>
			</div>
	...
	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-HQL4E2W0E9"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'G-HQL4E2W0E9');
	</script>
</body>
